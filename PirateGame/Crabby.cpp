...
void Crabby::setPosition(sf::Vector2f position)
{
...
void Crabby::LoadTexture() {
  sprite.setTexture(Textures::crabTexture);
  sprite.setTextureRect(sf::IntRect(0, 0, frameWidth, frameHeight));
}

void Crabby::ChangeAnimation(int style, float deltatime) {
  int line = 0;
  int totalFrame = 1;
  switch (style) {
...
void Crabby::HorizontalMovement(float deltatime)
{
  switch (animation)
  {
...
void Crabby::Update(float deltaTime, MAP& map) {
