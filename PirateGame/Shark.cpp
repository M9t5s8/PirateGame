...
void Shark::LoadTexture() {
  sprite.setTexture(Textures::sharkTexture);
  sprite.setTextureRect(sf::IntRect(0, 0, frameWidth, frameHeight));
}

void Shark::setPosition(sf::Vector2f position)
{
...
void Shark::ChangeAnimation(int style, float deltatime) {
  int line = 0;
  int totalFrame = 1;
  switch (style) {
  case 0: line = 0; totalFrame = 8; break;
...
void Shark::HorizontalMovement(float deltatime)
{
...
void Shark::Update(float deltaTime, MAP& map) 
{
